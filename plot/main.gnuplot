...
set terminal png font "Times,18"
#set terminal pdf font "Times,11"
#set terminal latex
set datafile separator ","

set style line 1 pointtype 7 pointsize 0.5 lc rgb 'black'
set style line 2 pointtype 9 pointsize 0.5 lc rgb '#0060ad'
#set style line 2 pointtype 9 pointsize 0.2 lc rgb '#42C19E'
set style line 80  lt 0 lc rgb "#808080" lw 0.5
set style line 81  lt 0 lc rgb "#808080" lw 2
set style line 102 lt 1 lc rgb '#808080' lw 0.5
...
set key box at 1600,11400 samplen 1 spacing 1.5

plot 'iphone6_1024.csv' using 3:4 t 'Overall' with points ls 1, \
